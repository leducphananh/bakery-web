...
import { AlertCircle, Cake, CheckCircle, Eye, EyeOff, Lock, Mail, User } from "lucide-react";
      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 flex min-h-screen items-center justify-center px-4">
          <div className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-xl">
            ...
            <h2 className="font-pacifico text-3xl text-green-600">
              Đăng ký thành công!
            </h2>
            <Alert className="mt-6 border-green-200 bg-green-50">
              <AlertDescription className="text-green-800">
                Vui lòng kiểm tra email của bạn để xác thực tài khoản. Bạn sẽ
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            <Link href="/" className="inline-flex items-center gap-2 transition-transform hover:scale-105">
              <Cake className="h-10 w-10 text-[#FFB5C5]" />
              <span className="font-pacifico text-3xl text-[#8B5A3C]">
                Milove
              </span>
            </Link>
            <h1 className="mt-6 font-pacifico text-4xl text-[#8B5A3C]">
              Đăng ký
            </h1>
          ...
          <div className="rounded-3xl bg-white p-8 shadow-xl">
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="flex items-center gap-2 text-[#8B5A3C]">
                ...
                <div className="relative">
                  <Input
                    ...
                    minLength={6}
                    disabled={loading}
                    className="rounded-full border-2 border-gray-200 px-4 py-6 pr-12 focus:border-[#FFB5C5] focus:ring-[#FFB5C5]"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#8B5A3C]"
                  >
                    {showPassword ? (
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                ...
                disabled={loading}
                className="rounded-full border-2 border-gray-200 py-6 transition-all hover:border-[#FFB5C5] hover:bg-pink-50"
              >
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link
                href="/auth/login"
                className="font-semibold text-[#FFB5C5] transition-colors hover:text-[#FF8FAB]"
              >
                Đăng nhập ngay
              </Link>
            </p>
